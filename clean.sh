...
echo ----------------------------------------------
echo    Command: pylint -vv "$SCRIPT_DIR/cdislogging" --rcfile ~/.gen3/.github/linters/.python-lint
pylint -vv "$SCRIPT_DIR/cdislogging" --rcfile ~/.gen3/.github/.github/linters/.python-lint
